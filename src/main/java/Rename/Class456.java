...
IThreadedFileIO {
    ...
    public Class456(File chunkSaveLocationIn) {
    ...
    public Chunk loadChunk(World worldIn, int x, int z) throws IOException {
        ...
        if (nbttagcompound == null) {
            DataInputStream datainputstream = Class450.getChunkInputStream(this.chunkSaveLocation, x, z);
    ...
    private void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound p_75820_3_) {
        ...
        ExtendedBlockStorage[] var7 = aextendedblockstorage;
        int i1 = aextendedblockstorage.length;
        for (int var9 = 0; var9 < i1; ++var9) {
            ExtendedBlockStorage extendedblockstorage = var7[var9];
        ...
        for (i1 = 0; i1 < chunkIn.getEntityLists().length; ++i1) {
            for (Entity entity : chunkIn.getEntityLists()[i1]) {
                if (!entity.writeToNBTOptional(nbttagcompound = new NBTTagCompound())) continue;
