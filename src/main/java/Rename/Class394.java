...
implements Packet<INetHandlerPlayClient> {
    ...
    public Class394(int p_i45181_1_, short[] crammedPositionsIn, Chunk chunkIn) {
    ...
    public class BlockUpdateData {
        ...
        public BlockPos getPos() {
            return new BlockPos(Class394.this.chunkPosCoord.getBlock(this.chunkPosCrammed >> 12 & 0xF, this.chunkPosCrammed & 0xFF, this.chunkPosCrammed >> 8 & 0xF));
        }
