...
implements Packet<INetHandlerPlayClient> {
    ...
    public Class414(Type type, IChatComponent message) {
        this(type, message, -1, -1, -1);
    }

    public Class414(int fadeInTime, int displayTime, int fadeOutTime) {
        this(Type.TIMES, null, fadeInTime, displayTime, fadeOutTime);
    }

    public Class414(Type type, IChatComponent message, int fadeInTime, int displayTime, int fadeOutTime) {
        this.type = type;
    ...
    public static enum Type {
        ...
        public static Type byName(String name) {
            for (Type s45packettitle$type : Type.values()) {
