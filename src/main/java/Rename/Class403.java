...
implements Packet<INetHandlerPlayClient> {
    ...
    public Class403(int incomingWindowId, String incomingWindowTitle, IChatComponent windowTitleIn) {
        this(incomingWindowId, incomingWindowTitle, windowTitleIn, 0);
    }

    public Class403(int windowIdIn, String guiId, IChatComponent windowTitleIn, int slotCountIn) {
    ...
    public Class403(int windowIdIn, String guiId, IChatComponent windowTitleIn, int slotCountIn, int incomingEntityId) {
