...
implements Packet<INetHandlerPlayServer> {
    ...
    public Class355(ItemStack stackIn) {
        this(field_179726_a, 255, stackIn, 0.0f, 0.0f, 0.0f);
    }

    public Class355(BlockPos positionIn, int placedBlockDirectionIn, ItemStack stackIn, float facingXIn, float facingYIn, float facingZIn) {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        this.facingX = (float)buf.readUnsignedByte() / Class2.Method2();
        this.facingY = (float)buf.readUnsignedByte() / Class2.Method2();
        this.facingZ = (float)buf.readUnsignedByte() / Class2.Method2();
    }
