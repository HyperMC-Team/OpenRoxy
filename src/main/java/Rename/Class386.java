...
implements Packet<INetHandlerPlayClient> {
    ...
    public Class386(Chunk chunkIn, boolean p_i45196_2_, int p_i45196_3_) {
        this.chunkX = chunkIn.xPosition;
        this.chunkZ = chunkIn.zPosition;
        this.field_149279_g = p_i45196_2_;
        this.extractedData = Class386.getExtractedData(chunkIn, p_i45196_2_, !chunkIn.getWorld().provider.getHasNoSky(), p_i45196_3_);
    }
    ...
    public static Extracted getExtractedData(Chunk p_179756_0_, boolean p_179756_1_, boolean p_179756_2_, int p_179756_3_) {
        ...
        s21packetchunkdata$extracted.data = new byte[Class386.func_180737_a(Integer.bitCount(s21packetchunkdata$extracted.dataSize), p_179756_2_, p_179756_1_)];
        int j = 0;
        ...
        for (ExtendedBlockStorage extendedblockstorage2 : list) {
            j = Class386.func_179757_a(extendedblockstorage2.getBlocklightArray().getData(), s21packetchunkdata$extracted.data, j);
        }
        if (p_179756_2_) {
            for (ExtendedBlockStorage extendedblockstorage3 : list) {
                j = Class386.func_179757_a(extendedblockstorage3.getSkylightArray().getData(), s21packetchunkdata$extracted.data, j);
            }
        }
        if (p_179756_1_) {
            Class386.func_179757_a(p_179756_0_.getBiomeArray(), s21packetchunkdata$extracted.data, j);
        }
