...
extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonOF(210, this.width / 2 - 155, this.height / 6 + 24 * ((i += 2) >> 1), 150, 20, I18n.format("of.options.capeOF.openEditor")));
        ...
        this.buttonCopyLink = new GuiButtonOF(230, this.width / 2 - 100, this.height / 6 + 24 * ((i += 6) >> 1), 200, 20, I18n.format("of.options.capeOF.copyEditorLink"));
        this.buttonCopyLink.visible = this.linkUrl != null;
        this.buttonList.add(this.buttonCopyLink);
        this.buttonList.add(new GuiButtonOF(200, this.width / 2 - 100, this.height / 6 + 24 * ((i += 4) >> 1), I18n.format("gui.done")));
    }
        ...
        if (button.enabled) {
            ...
            if (button.id == 210) {
                try {
                    ...
                    Config.warn(((Object) invalidcredentialsexception).getClass().getName() + ": " + invalidcredentialsexception.getMessage());
                }
