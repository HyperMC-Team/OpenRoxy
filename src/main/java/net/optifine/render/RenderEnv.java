...
public class RenderEnv {
    ...
    public boolean isSmartLeaves() {
        if (this.smartLeaves == -1) {
            this.smartLeaves = Config.isTreesSmart() && this.blockState.getBlock() instanceof BlockLeaves ? 1 : 0;
        }
    ...
    public ListQuadsOverlay getListQuadsOverlay(EnumWorldBlockLayer layer) {
        ...
        if (listquadsoverlay == null) {
            this.listsQuadsOverlay[layer.ordinal()] = listquadsoverlay = new ListQuadsOverlay();
        }
