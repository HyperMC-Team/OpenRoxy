    ...
    static {
        for (int i = 0; i < 1000; ++i) {
            ...
            if (mapIdByClass.containsKey(oclass)) {
                Config.warn("Duplicate entity class: " + String.valueOf(oclass) + ", id1: " + String.valueOf(mapIdByClass.get(oclass)) + ", id2: " + i);
            }
            if (mapIdByName.containsKey(s)) {
                Config.warn("Duplicate entity name: " + s + ", id1: " + String.valueOf(mapIdByName.get(s)) + ", id2: " + i);
            }
            if (mapClassByName.containsKey(s)) {
                Config.warn("Duplicate entity name: " + s + ", class1: " + String.valueOf(mapClassByName.get(s)) + ", class2: " + String.valueOf(oclass));
            }
