...
public class Reflector {
    ...
    public static ReflectorClass ChunkWatchEvent_UnWatch = new ReflectorClass("net.minecraftforge.events.world.ChunkWatchEvent$UnWatch");
    ...
    public static ReflectorClass DrawScreenEvent_Pre = new ReflectorClass("net.minecraftforge.client.events.GuiScreenEvent$DrawScreenEvent$Pre");
    ...
    public static ReflectorClass DrawScreenEvent_Post = new ReflectorClass("net.minecraftforge.client.events.GuiScreenEvent$DrawScreenEvent$Post");
    ...
    public static ReflectorClass EntityViewRenderEvent_CameraSetup = new ReflectorClass("net.minecraftforge.client.events.EntityViewRenderEvent$CameraSetup");
    ...
    public static ReflectorClass EntityViewRenderEvent_FogColors = new ReflectorClass("net.minecraftforge.client.events.EntityViewRenderEvent$FogColors");
    ...
    public static ReflectorClass Event = new ReflectorClass("net.minecraftforge.fml.common.eventhandler.Class7");
    ...
    public static ReflectorClass Event_Result = new ReflectorClass("net.minecraftforge.fml.common.eventhandler.Class7$Result");
    ...
    public static ReflectorClass ForgeEventFactory = new ReflectorClass("net.minecraftforge.events.ForgeEventFactory");
    ...
    public static ReflectorClass RenderBlockOverlayEvent_OverlayType = new ReflectorClass("net.minecraftforge.client.events.RenderBlockOverlayEvent$OverlayType");
    ...
    public static ReflectorClass RenderItemInFrameEvent = new ReflectorClass("net.minecraftforge.client.events.RenderItemInFrameEvent");
    ...
    public static ReflectorClass RenderLivingEvent_Pre = new ReflectorClass("net.minecraftforge.client.events.RenderLivingEvent$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Post = new ReflectorClass("net.minecraftforge.client.events.RenderLivingEvent$Post");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Pre = new ReflectorClass("net.minecraftforge.client.events.RenderLivingEvent$Specials$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Post = new ReflectorClass("net.minecraftforge.client.events.RenderLivingEvent$Specials$Post");
    ...
    public static ReflectorClass WorldEvent_Load = new ReflectorClass("net.minecraftforge.events.world.Class55$Load");
    ...
    private static void dbgCall(boolean isStatic, String callType, ReflectorMethod refMethod, Object[] params, Object retVal) {
        ...
        Log.dbg(callType + s2 + " " + s + "." + s1 + "(" + ArrayUtils.arrayToString(params) + ") => " + String.valueOf(retVal));
    }
    ...
    private static void dbgFieldValue(boolean isStatic, String accessType, ReflectorField refField, Object val) {
        ...
        Log.dbg(accessType + s2 + " " + s + "." + s1 + " => " + String.valueOf(val));
    }
