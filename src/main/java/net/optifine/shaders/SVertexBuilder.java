...
public class SVertexBuilder {
    ...
    public void calcNormal(WorldRenderer wrr, int baseIndex) {
        ...
        int j = (int)(f30 * 127.0f) & 0xFF;
        int k = (int)(f31 * 127.0f) & 0xFF;
        int l = (int)(f32 * 127.0f) & 0xFF;
        int i1 = (l << 16) + (k << 8) + j;
    ...
    public static void drawArrays(int drawMode, int first, int count, WorldRenderer wrr) {
        if (count != 0) {
            ...
            if (i == 56) {
                ...
                GL20.glVertexAttribPointer((int)Shaders.midTexCoordAttrib, (int)2, (int)5126, (boolean)false, (int)i, (ByteBuffer)bytebuffer);
                bytebuffer.position(40);
                GL20.glVertexAttribPointer((int)Shaders.tangentAttrib, (int)4, (int)5122, (boolean)false, (int)i, (ByteBuffer)bytebuffer);
                bytebuffer.position(48);
                GL20.glVertexAttribPointer((int)Shaders.entityAttrib, (int)3, (int)5122, (boolean)false, (int)i, (ByteBuffer)bytebuffer);
