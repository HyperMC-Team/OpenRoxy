...
public class ShaderMacros {
    ...
    public static String getVendor() {
        ...
        return (s = s.toLowerCase()).startsWith("ati") ? MC_GL_VENDOR_ATI : (s.startsWith("intel") ? MC_GL_VENDOR_INTEL : (s.startsWith("nvidia") ? MC_GL_VENDOR_NVIDIA : (s.startsWith("x.org") ? MC_GL_VENDOR_XORG : MC_GL_VENDOR_OTHER)));
    }
