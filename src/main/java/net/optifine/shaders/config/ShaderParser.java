...
public class ShaderParser {
    ...
    public static int getShadowDepthIndex(String uniform) {
        return uniform.equals("shadow") ? 0 : (uniform.equals("watershadow") ? 1 : ShaderParser.getIndex(uniform, "shadowtex", 0, 1));
    }

    public static int getShadowColorIndex(String uniform) {
        return uniform.equals("shadowcolor") ? 0 : ShaderParser.getIndex(uniform, "shadowcolor", 0, 1);
    }
