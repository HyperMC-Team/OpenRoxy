...
public class RandomEntities {
    ...
    private static final RandomEntity randomEntity;
    private static TileEntityRendererDispatcher tileEntityRendererDispatcher;
    private static final RandomTileEntity randomTileEntity;
    ...
    public static void entityUnloaded() {
    }
    ...
    public static void worldChanged(World oldWorld, World newWorld) {
        Class54 worldChangeEvent = new Class54(oldWorld, newWorld);
        Class13.Method7(worldChangeEvent);
        if (worldChangeEvent.isCancelled() || newWorld == null) {
            return;
        }
        List<Entity> entities = newWorld.getLoadedEntityList();
    ...
    private static ResourceLocation getLocationProperties(ResourceLocation loc, boolean mcpatcher) {
        ...
        ResourceLocation resourcelocation1 = new ResourceLocation(s, s3 = (s2 = StrUtils.removeSuffix(s1 = resourcelocation.getResourcePath(), SUFFIX_PNG)) + SUFFIX_PROPERTIES);
    ...
    private static void initialize() {
        ...
        for (int i = 0; i < astring2.length; ++i) {
            ...
            String s1 = RandomEntities.getPathBase((String)(s = s + SUFFIX_PNG));
