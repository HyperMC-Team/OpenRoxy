...
extends Container {
    ...
    public ContainerBrewingStand(InventoryPlayer playerInventory, IInventory tileBrewingStandIn) {
        ...
        this.theSlot = this.addSlotToContainer(new Ingredient(this, tileBrewingStandIn, 3, 79, 17));
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
    ...
    class Ingredient
    extends Slot {
        public Ingredient(ContainerBrewingStand this$0, IInventory inventoryIn, int index, int xPosition, int yPosition) {
            super(inventoryIn, index, xPosition, yPosition);
        }
