...
public abstract class MobSpawnerBaseLogic {
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("SpawnPotentials", 9)) {
            ...
            for (int i = 0; i < nbttaglist.tagCount(); ++i) {
                this.minecartToSpawn.add(new WeightedRandomMinecart(this, nbttaglist.getCompoundTagAt(i)));
            }
        }
        if (nbt.hasKey("SpawnData", 10)) {
            this.setRandomEntity(new WeightedRandomMinecart(this, nbt.getCompoundTag("SpawnData"), this.mobID));
        } else {
    ...
    public Entity func_180612_a(World worldIn) {
        Entity entity;
        if (this.cachedEntity == null && (entity = EntityList.createEntityByName(this.getEntityNameToSpawn(), worldIn)) != null) {
    ...
    extends WeightedRandom.Item {
        ...
        public WeightedRandomMinecart(MobSpawnerBaseLogic this$0, NBTTagCompound tagCompound) {
            this(this$0, tagCompound.getCompoundTag("Properties"), tagCompound.getString("Type"), tagCompound.getInteger("Weight"));
        }

        public WeightedRandomMinecart(MobSpawnerBaseLogic this$0, NBTTagCompound tagCompound, String type) {
            this(this$0, tagCompound, type, 1);
        }

        private WeightedRandomMinecart(MobSpawnerBaseLogic this$0, NBTTagCompound tagCompound, String type, int weight) {
            super(weight);
