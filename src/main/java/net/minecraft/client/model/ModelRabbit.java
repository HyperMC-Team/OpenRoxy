...
extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.rabbitRightEar.rotateAngleX = this.rabbitLeftEar.rotateAngleX = headPitch * ((float)Math.PI / 180);
        this.rabbitHead.rotateAngleX = this.rabbitLeftEar.rotateAngleX;
        this.rabbitNose.rotateAngleX = this.rabbitLeftEar.rotateAngleX;
        this.rabbitNose.rotateAngleY = this.rabbitHead.rotateAngleY = netHeadYaw * ((float)Math.PI / 180);
