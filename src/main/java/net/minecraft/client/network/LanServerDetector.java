...
public class LanServerDetector {
    ...
    extends Thread {
        ...
        public void run() {
            ...
            while (!this.isInterrupted()) {
                ...
                logger.debug(String.valueOf(datagrampacket.getAddress()) + ": " + s);
    ...
    public static class LanServerList {
        ...
        public synchronized void func_77551_a(String p_77551_1_, InetAddress p_77551_2_) {
            ...
            Object s1 = ThreadLanServerPing.getAdFromPingResponse(p_77551_1_);
            if (s1 != null) {
                s1 = p_77551_2_.getHostAddress() + ":" + (String)s1;
                boolean flag = false;
                ...
                if (!flag) {
                    this.listOfLanServers.add(new LanServer(s, (String)s1));
