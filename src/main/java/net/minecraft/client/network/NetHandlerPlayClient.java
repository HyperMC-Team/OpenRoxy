...
import Rename.Class44;
import Rename.Class53;
...
implements INetHandlerPlayClient {
    ...
    @Override
    public void handleJoinGame(Class411 packetIn) {
        ...
        this.netManager.sendPacket(new Class361("MC|Brand", new PacketBuffer(Unpooled.buffer()).writeString(ClientBrandRetriever.getClientModName())));
    }

    @Override
    public void handleSpawnObject(Class339 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleSpawnExperienceOrb(Class373 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleSpawnGlobalEntity(Class346 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleSpawnPainting(Class418 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleEntityVelocity(Class349 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityID());
        if (entity != null) {
            if (entity == Minecraft.getMinecraft().thePlayer) {
                Class53 event = new Class53(1.0);
                Class13.Method7(event);
                entity.setVelocity((double)packetIn.getMotionX() / 8000.0 * event.getReduceAmount(), (double)packetIn.getMotionY() / 8000.0, (double)packetIn.getMotionZ() / 8000.0 * event.getReduceAmount());
            } else {
    ...
    @Override
    public void handleEntityMetadata(Class419 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
    ...
    @Override
    public void handleSpawnPlayer(Class368 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        double d0 = (double)packetIn.getX() / 32.0;
        double d1 = (double)packetIn.getY() / 32.0;
        double d2 = (double)packetIn.getZ() / 32.0;
    ...
    @Override
    public void handleEntityTeleport(Class406 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
        if (entity != null) {
            entity.serverPosX = packetIn.getX();
    ...
    @Override
    public void handleHeldItemChange(Class374 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleEntityMovement(Class397 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleEntityHeadLook(Class404 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = packetIn.getEntity(this.clientWorldController);
        if (entity != null) {
            float f = (float)(packetIn.getYaw() * 360) / 256.0f;
    ...
    @Override
    public void handleDestroyEntities(Class402 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handlePlayerPosLook(Class351 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        ...
        if (packetIn.func_179834_f().contains((Object) Class351.EnumFlags.X)) {
            d0 += entityplayer.posX;
        } else {
            entityplayer.motionX = 0.0;
        }
        if (packetIn.func_179834_f().contains((Object) Class351.EnumFlags.Y)) {
            d1 += entityplayer.posY;
        } else {
            entityplayer.motionY = 0.0;
        }
        if (packetIn.func_179834_f().contains((Object) Class351.EnumFlags.Z)) {
            d2 += entityplayer.posZ;
        } else {
            entityplayer.motionZ = 0.0;
        }
        if (packetIn.func_179834_f().contains((Object) Class351.EnumFlags.X_ROT)) {
            f1 += entityplayer.rotationPitch;
        }
        if (packetIn.func_179834_f().contains((Object) Class351.EnumFlags.Y_ROT)) {
            f += entityplayer.rotationYaw;
        }
        entityplayer.setPositionAndRotation(d0, d1, d2, f, f1);
        this.netManager.sendPacket(new Class354.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.getEntityBoundingBox().minY, entityplayer.posZ, entityplayer.rotationYaw, entityplayer.rotationPitch, false));
    ...
    @Override
    public void handleMultiBlockChange(Class394 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        for (Class394.BlockUpdateData s22packetmultiblockchange$blockupdatedata : packetIn.getChangedBlocks()) {
    ...
    @Override
    public void handleChunkData(Class386 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(Class1.instance.Method3()), "disconnect.lost", reason));
        }
    }
    ...
    @Override
    public void handleCollectItem(Class369 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleChat(Class420 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleAnimation(Class367 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityID());
        if (entity != null) {
            if (packetIn.getAnimationType() == 0) {
                ...
                Class13.Method7(new Class44(entity));
    ...
    @Override
    public void handleUseBed(Class338 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        packetIn.getPlayer(this.clientWorldController).trySleep(packetIn.getBedPosition());
    }

    @Override
    public void handleSpawnMob(Class345 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        double d0 = (double)packetIn.getX() / 32.0;
        double d1 = (double)packetIn.getY() / 32.0;
        double d2 = (double)packetIn.getZ() / 32.0;
    ...
    @Override
    public void handleTimeUpdate(Class341 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleSpawnPosition(Class400 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleEntityAttach(Class370 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
    ...
    @Override
    public void handleEntityStatus(Class415 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = packetIn.getEntity(this.clientWorldController);
        if (entity != null) {
    ...
    @Override
    public void handleUpdateHealth(Class398 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleExplosion(Class384 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleOpenWindow(Class403 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleSetSlot(Class378 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityPlayerSP entityplayer = this.gameController.thePlayer;
        if (packetIn.getWindowId() == -1) {
            ...
            if (guiScreen instanceof GuiContainerCreative) {
                GuiContainerCreative guicontainercreative = (GuiContainerCreative)guiScreen;
            ...
            if (packetIn.getWindowId() == 0 && packetIn.getSlot() >= 36 && packetIn.getSlot() < 45) {
                ...
                if (packetIn.getItem() != null && (itemstack == null || itemstack.stackSize < packetIn.getItem().stackSize)) {
                    packetIn.getItem().animationsToGo = 0;
                }
    ...
    @Override
    public void handleConfirmTransaction(Class391 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        ...
        if (container != null && !packetIn.func_148888_e()) {
            Class353 packet = new Class353(packetIn.getWindowId(), packetIn.getActionNumber(), true);
            if (Class267.getGrimPost()) {
                Class267.fixC0F(packet);
            } else {
    ...
    @Override
    public void handleWindowItems(Class393 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityPlayerSP entityplayer = this.gameController.thePlayer;
    ...
    @Override
    public void handleSignEditorOpen(Class408 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleUpdateSign(Class405 packetIn) {
    ...
    @Override
    public void handleUpdateTileEntity(Class385 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleWindowProperty(Class390 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityPlayerSP entityplayer = this.gameController.thePlayer;
    ...
    @Override
    public void handleEntityEquipment(Class376 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityID());
        if (entity != null) {
    ...
    @Override
    public void handleCloseWindow(Class340 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.thePlayer.closeScreenAndDropStack();
    }

    @Override
    public void handleBlockAction(Class380 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleChangeGameState(Class342 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityPlayerSP entityplayer = this.gameController.thePlayer;
        int i = packetIn.getGameState();
        float f = packetIn.func_149137_d();
        int j = MathHelper.floor_float(f + 0.5f);
        if (i >= 0 && i < Class342.MESSAGE_NAMES.length && Class342.MESSAGE_NAMES[i] != null) {
            ((EntityPlayer)entityplayer).addChatComponentMessage(new ChatComponentTranslation(Class342.MESSAGE_NAMES[i], new Object[0]));
        }
        if (i == 1) {
    ...
    @Override
    public void handleMaps(Class395 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleEffect(Class381 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleStatistics(Class392 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        boolean flag = false;
    ...
    @Override
    public void handleEntityEffect(Class347 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
    ...
    @Override
    public void handleCombatEvent(Class422 packetIn) {
        Entity entity1;
        ...
        if (packetIn.eventType == Class422.Event.END_COMBAT) {
        ...
        } else if (packetIn.eventType == Class422.Event.ENTITY_DIED && (entity1 = this.clientWorldController.getEntityByID(packetIn.field_179774_b)) instanceof EntityPlayer) {
    ...
    @Override
    public void handleServerDifficulty(Class416 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleCamera(Class410 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = packetIn.getEntity(this.clientWorldController);
        if (entity != null) {
    ...
    @Override
    public void handleWorldBorder(Class387 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        packetIn.func_179788_a(this.clientWorldController.getWorldBorder());
    }

    @Override
    public void handleTitle(Class414 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Class414.Type s45packettitle$type = packetIn.getType();
        String s = null;
        String s1 = null;
    ...
    @Override
    public void handleSetCompressionLevel(Class421 packetIn) {
    ...
    @Override
    public void handlePlayerListHeaderFooter(Class409 packetIn) {
    ...
    @Override
    public void handleRemoveEntityEffect(Class407 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
        if (entity instanceof EntityLivingBase) {
    ...
    @Override
    public void handlePlayerListItem(Class412 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        for (Class412.AddPlayerData s38packetplayerlistitem$addplayerdata : packetIn.getEntries()) {
            if (packetIn.getAction() == Class412.Action.REMOVE_PLAYER) {
            ...
            if (packetIn.getAction() == Class412.Action.ADD_PLAYER) {
    ...
    @Override
    public void handleKeepAlive(Class371 packetIn) {
        this.addToSendQueue(new Class359(packetIn.func_149134_c()));
    }

    @Override
    public void handlePlayerAbilities(Class417 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityPlayerSP entityplayer = this.gameController.thePlayer;
    ...
    @Override
    public void handleTabComplete(Class348 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleSoundEffect(Class389 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
    ...
    @Override
    public void handleResourcePack(Class423 packetIn) {
        ...
        if (s.startsWith("level://")) {
            ...
            if (file2.isFile()) {
                this.netManager.sendPacket(new Class366(s1, Class366.Action.ACCEPTED));
                Futures.addCallback(this.gameController.getResourcePackRepository().setResourcePackInstance(file2), (FutureCallback)new FutureCallback<Object>(){
                    ...
                    public void onSuccess(Object p_onSuccess_1_) {
                        NetHandlerPlayClient.this.netManager.sendPacket(new Class366(s1, Class366.Action.SUCCESSFULLY_LOADED));
                    }

                    public void onFailure(Throwable p_onFailure_1_) {
                        NetHandlerPlayClient.this.netManager.sendPacket(new Class366(s1, Class366.Action.FAILED_DOWNLOAD));
                    }
                });
            } else {
                this.netManager.sendPacket(new Class366(s1, Class366.Action.FAILED_DOWNLOAD));
            }
            ...
            this.netManager.sendPacket(new Class366(s1, Class366.Action.ACCEPTED));
            Futures.addCallback(this.gameController.getResourcePackRepository().downloadResourcePack(s, s1), (FutureCallback)new FutureCallback<Object>(){
            ...
            this.netManager.sendPacket(new Class366(s1, Class366.Action.DECLINED));
        } else {
                    ...
                    NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback(){
                        ...
                        public void confirmClicked(boolean result, int id) {
                            ...
                            if (result) {
                                ...
                                NetHandlerPlayClient.this.netManager.sendPacket(new Class366(s1, Class366.Action.ACCEPTED));
                                Futures.addCallback(NetHandlerPlayClient.this.gameController.getResourcePackRepository().downloadResourcePack(s, s1), (FutureCallback)new FutureCallback<Object>(){
                                ...
                                NetHandlerPlayClient.this.netManager.sendPacket(new Class366(s1, Class366.Action.DECLINED));
                            }
    ...
    @Override
    public void handleEntityNBT(Class424 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = packetIn.getEntity(this.clientWorldController);
        if (entity != null) {
     ...
     */
    @Override
    public void handleCustomPayload(Class377 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Class482.INSTANCE.handleS3F(packetIn);
    ...
    @Override
    public void handleScoreboardObjective(Class379 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Scoreboard scoreboard = this.clientWorldController.getScoreboard();
    ...
    @Override
    public void handleUpdateScore(Class350 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Scoreboard scoreboard = this.clientWorldController.getScoreboard();
        ScoreObjective scoreobjective = scoreboard.getObjective(packetIn.getObjectiveName());
        if (packetIn.getScoreAction() == Class350.Action.CHANGE) {
        ...
        } else if (packetIn.getScoreAction() == Class350.Action.REMOVE) {
    ...
    @Override
    public void handleDisplayScoreboard(Class372 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Scoreboard scoreboard = this.clientWorldController.getScoreboard();
    ...
    @Override
    public void handleTeams(Class375 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Scoreboard scoreboard = this.clientWorldController.getScoreboard();
    ...
    @Override
    public void handleParticles(Class399 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        if (packetIn.getParticleCount() == 0) {
            ...
            try {
                ...
                logger.warn("Could not spawn particle effect " + String.valueOf((Object)packetIn.getParticleType()));
            }
        } else {
    ...
    @Override
    public void handleEntityProperties(Class388 packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
        if (entity != null) {
            if (!(entity instanceof EntityLivingBase)) {
            ...
            for (Class388.Snapshot s20packetentityproperties$snapshot : packetIn.func_149441_d()) {
