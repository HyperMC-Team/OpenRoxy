...
IStream {
    ...
    public TwitchStream(Minecraft mcIn, final Property streamProperty) {
        ...
        if (streamProperty != null && !Strings.isNullOrEmpty((String)streamProperty.getValue()) && OpenGlHelper.framebufferSupported) {
    ...
    public void func_152922_k() {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused()) {
            ...
            boolean bl = flag = k >= (j = (long)(1000000000 / this.targetFPS));
            if (flag) {
    ...
    public void func_152930_t() {
        ...
        LOGGER.info(STREAM_MARKER, "Streaming at {}/{} at {} kbps to {}", new Object[]{videoparams.outputWidth, videoparams.outputHeight, videoparams.maxKbps, this.broadcastController.getIngestServer().serverUrl});
    ...
    public void func_152893_b(ErrorCode p_152893_1_) {
        ...
        this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new ChatComponentText("Issue streaming frame: " + String.valueOf(p_152893_1_) + " (" + ErrorCode.getString((ErrorCode)p_152893_1_) + ")"), 2);
    }
    ...
    public void func_176023_d(ErrorCode p_176023_1_) {
        if (ErrorCode.failed((ErrorCode)p_176023_1_)) {
    ...
    public void func_176022_e(ErrorCode p_176022_1_) {
        if (ErrorCode.failed((ErrorCode)p_176022_1_)) {
    ...
    public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_) {
        for (ChatRawMessage chatrawmessage : p_180605_2_) {
            ...
            if (!this.func_176028_a(chatrawmessage.modes, chatrawmessage.subscriptions, this.mc.gameSettings.streamChatUserFilter)) continue;
