...
implements IProgressMeter {
    ...
    public GuiAchievements(GuiScreen parentScreenIn, StatFileWriter statFileWriterIn) {
        ...
        int i = 141;
        int j = 141;
        this.field_146567_u = this.field_146565_w = (double)(AchievementList.openInventory.displayColumn * 24 - i / 2 - 12);
        this.field_146569_s = this.field_146565_w;
        this.field_146566_v = this.field_146573_x = (double)(AchievementList.openInventory.displayRow * 24 - j / 2);
        this.field_146568_t = this.field_146573_x;
    }

    @Override
    public void initGui() {
        this.mc.getNetHandler().addToSendQueue(new Class337(Class337.EnumState.REQUEST_STATS));
