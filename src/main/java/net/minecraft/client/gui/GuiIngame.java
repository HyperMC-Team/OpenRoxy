...
import Rename.Class38;
import Rename.Class40;
import Rename.Class262;
import Rename.Class322;
import Rename.Class283;
import Rename.Class148;
...
extends Gui {
    ...
    private float animUp;
    private float animDown;
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Class13.Method7(new Class40(true));
        if (this.mc.playerController.isSpectator()) {
            this.spectatorGui.renderTooltip(scaledresolution, partialTicks);
        } else {
            this.renderTooltip(scaledresolution, partialTicks);
        }
        Class262.getModule(Class322.class).render();
        ...
        Class38 event = new Class38(partialTicks, scaledresolution);
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        boolean animModEnable = Class283.getInstance.isState();
        if (animModEnable) {
            ...
            if (entity instanceof EntityPlayer) {
                ...
                float needUp = 3.0f;
                GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
                this.animUp = (float)sr.getScaledHeight() - 22.0f;
                float i = (float)sr.getScaledWidth() / 2.0f;
                float f = zLevel;
                zLevel = -90.0f;
                this.anim = Class461.moveUDFaster(this.anim, entityplayer.inventory.currentItem * 20);
                Class148.drawRound(i - 90.0f, this.animUp, 180.0f, 20.0f, 6.0f, new Color(0, 0, 0, 150));
                Class148.drawRound(i - 90.0f + this.anim, this.animUp, 20.0f, 20.0f, 6.0f, new Color(233, 233, 233, 100));
                zLevel = f;
                ...
                GlStateManager.pushMatrix();
                int l = (int)((float)(sr.getScaledHeight() - 15 - 3) - 3.0f);
                for (int j = 0; j < 9; ++j) {
                    float k = (float)sr.getScaledWidth() / 2.0f - 90.0f + (float)(j * 20) + 2.0f;
                    this.renderHotbarItem(j, (int)k, l, partialTicks, entityplayer);
                }
                GlStateManager.popMatrix();
            ...
            this.drawTexturedModalRect(i - 91 - 1 + Class1.instance.Method12().getSpoofedSlot() * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            zLevel = f;
            GlStateManager.enableRescaleNormal();
            GlStateManager.enableBlend();
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        ArrayList<Score> collection = (ArrayList) scoreboard.getSortedScores(objective);
        ...
        for (Score score : collection) {
            ...
            String s = ScorePlayerTeam.formatPlayerName(scoreplayerteam, score.getPlayerName()) + ": " + String.valueOf((Object)EnumChatFormatting.RED) + score.getScorePoints();
        ...
        for (Score score1 : collection) {
            ...
            String s2 = String.valueOf((Object)EnumChatFormatting.RED) + score1.getScorePoints();
