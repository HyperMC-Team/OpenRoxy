...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            Object s = ingestserver.serverUrl.replaceAll("\\{stream_key\\}", "");
            ...
            if (ingestservertester != null) {
                if (ingestserver == ingestservertester.func_153040_c()) {
                    s = String.valueOf((Object)EnumChatFormatting.GREEN) + (String)s;
                    ...
                    if (ingestserver.bitrateKbps == 0.0f) {
                        s1 = String.valueOf((Object)EnumChatFormatting.RED) + "Down!";
                    }
                } else {
                    s1 = String.valueOf((Object)EnumChatFormatting.OBFUSCATED) + "1234" + String.valueOf((Object)EnumChatFormatting.RESET) + " kbps";
                }
            ...
            if (this.isSelected(entryID)) {
                s2 = String.valueOf((Object)EnumChatFormatting.BLUE) + "(Preferred)";
            } else if (ingestserver.defaultServer) {
                s2 = String.valueOf((Object)EnumChatFormatting.GREEN) + "(Default)";
            }
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, (String)s, p_180791_2_ + 2, p_180791_3_ + ((GuiIngestServers)GuiIngestServers.this).fontRendererObj.FONT_HEIGHT + 5 + 3, 0x303030);
