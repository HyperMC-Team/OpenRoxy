...
extends GuiScreen {
    ...
    private void sendBookToServer(boolean publish) throws IOException {
        if (this.bookIsUnsigned && this.bookIsModified && this.bookPages != null) {
            ...
            this.mc.getNetHandler().addToSendQueue(new Class361(s2, packetbuffer));
        }
    }
    ...
    private void pageInsertIntoCurrent(String p_146459_1_) {
        ...
        int i = this.fontRendererObj.splitStringWidth(s1 + String.valueOf((Object)EnumChatFormatting.BLACK) + "_", 118);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            Object s = this.bookTitle;
            if (this.bookIsUnsigned) {
                s = this.updateCount / 6 % 2 == 0 ? (String)s + String.valueOf((Object)EnumChatFormatting.BLACK) + "_" : (String)s + String.valueOf((Object)EnumChatFormatting.GRAY) + "_";
            }
            ...
            int l = this.fontRendererObj.getStringWidth((String)s);
            this.fontRendererObj.drawString((String)s, i + 36 + (116 - l) / 2, j + 48, 0);
            String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName());
            int i1 = this.fontRendererObj.getStringWidth(s2);
            this.fontRendererObj.drawString(String.valueOf((Object)EnumChatFormatting.DARK_GRAY) + s2, i + 36 + (116 - i1) / 2, j + 48 + 10, 0);
            ...
            if (this.bookIsUnsigned) {
                s5 = this.fontRendererObj.getBidiFlag() ? (String)s5 + "_" : (this.updateCount / 6 % 2 == 0 ? (String)s5 + String.valueOf((Object)EnumChatFormatting.BLACK) + "_" : (String)s5 + String.valueOf((Object)EnumChatFormatting.GRAY) + "_");
            ...
            if (this.field_175386_A == null) {
                this.fontRendererObj.drawSplitString((String)s5, i + 36, j + 16 + 16, 116, 0);
            } else {
