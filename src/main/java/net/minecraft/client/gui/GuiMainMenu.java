...
implements GuiYesNoCallback {
    ...
    public static final String field_96138_a = "Please click " + String.valueOf((Object)EnumChatFormatting.UNDERLINE) + "here" + String.valueOf((Object)EnumChatFormatting.RESET) + " for more information.";
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Reflector.FMLCommonHandler_getBrandings.exists()) {
            ...
            this.drawString(this.fontRendererObj, (String)s, 2, this.height - 10, -1);
        }
