...
implements GuiYesNoCallback {
    ...
    public void addWorldSelectionButtons() {
        this.selectButton = new GuiButton(1, this.width / 2 - 154, this.height - 52, 150, 20, I18n.format("selectWorld.select", new Object[0]));
        ...
        this.renameButton = new GuiButton(6, this.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.rename", new Object[0]));
        this.buttonList.add(this.renameButton);
        this.deleteButton = new GuiButton(2, this.width / 2 - 76, this.height - 28, 72, 20, I18n.format("selectWorld.delete", new Object[0]));
        this.buttonList.add(this.deleteButton);
        this.recreateButton = new GuiButton(7, this.width / 2 + 4, this.height - 28, 72, 20, I18n.format("selectWorld.recreate", new Object[0]));
    ...
    public void func_146615_e(int p_146615_1_) {
        ...
        if (!this.field_146634_i) {
            ...
            Object s = this.func_146621_a(p_146615_1_);
            if (s == null) {
                s = "World" + p_146615_1_;
            }
            ...
            if (this.mc.getSaveLoader().canLoadWorld((String)s)) {
                this.mc.launchIntegratedServer((String)s, (String)s1, null);
            }
        }
    }
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            Object s = saveformatcomparator.getDisplayName();
            if (StringUtils.isEmpty((CharSequence)s)) {
                s = GuiSelectWorld.this.field_146637_u + " " + (entryID + 1);
            }
            Object s1 = saveformatcomparator.getFileName();
            s1 = (String)s1 + " (" + GuiSelectWorld.this.field_146633_h.format(new Date(saveformatcomparator.getLastTimePlayed()));
            s1 = (String)s1 + ")";
            Object s2 = "";
            if (saveformatcomparator.requiresConversion()) {
                s2 = GuiSelectWorld.this.field_146636_v + " " + (String)s2;
            } else {
                s2 = GuiSelectWorld.this.field_146635_w[saveformatcomparator.getEnumGameType().getID()];
                if (saveformatcomparator.isHardcoreModeEnabled()) {
                    s2 = String.valueOf((Object)EnumChatFormatting.DARK_RED) + I18n.format("gameMode.hardcore", new Object[0]) + String.valueOf((Object)EnumChatFormatting.RESET);
                }
                if (saveformatcomparator.getCheatsEnabled()) {
                    s2 = (String)s2 + ", " + I18n.format("selectWorld.cheats", new Object[0]);
                }
            }
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, (String)s, p_180791_2_ + 2, p_180791_3_ + 1, 0xFFFFFF);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, (String)s1, p_180791_2_ + 2, p_180791_3_ + 12, 0x808080);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, (String)s2, p_180791_2_ + 2, p_180791_3_ + 12 + 10, 0x808080);
        }
    }
}
