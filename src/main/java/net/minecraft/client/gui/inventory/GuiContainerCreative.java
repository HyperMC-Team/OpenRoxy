...
extends InventoryEffectRenderer {
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_) {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory) {
            ...
            for (int j = 0; j < container.inventorySlots.size(); ++j) {
                CreativeSlot slot = new CreativeSlot(this, container.inventorySlots.get(j), j);
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            ...
            if (creativetabs != null) {
                list.add(1, String.valueOf((Object)EnumChatFormatting.BOLD) + String.valueOf((Object)EnumChatFormatting.BLUE) + I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0]));
            }
    ...
    extends Slot {
        ...
        public CreativeSlot(GuiContainerCreative this$0, Slot p_i46313_2_, int p_i46313_3_) {
