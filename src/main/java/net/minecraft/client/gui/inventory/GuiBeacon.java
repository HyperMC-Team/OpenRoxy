...
extends GuiContainer {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == -2) {
            ...
            this.mc.getNetHandler().addToSendQueue(new Class361(s, packetbuffer));
            this.mc.displayGuiScreen(null);
    ...
    extends Button {
        ...
        @Override
        public void drawButtonForegroundLayer(int mouseX, int mouseY) {
            Object s = I18n.format(Potion.potionTypes[this.field_146149_p].getName(), new Object[0]);
            if (this.field_146148_q >= 3 && this.field_146149_p != Potion.regeneration.id) {
                s = (String)s + " II";
            }
            GuiBeacon.this.drawCreativeTabHoveringText((String)s, mouseX, mouseY);
        }
    }
