...
extends GuiScreen {
    ...
    public void onGuiClosed() {
        ...
        if (nethandlerplayclient != null) {
            nethandlerplayclient.addToSendQueue(new Class357(this.tileSign.getPos(), this.tileSign.signText));
        }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (keyCode == 14 && ((String)s).length() > 0) {
        ...
        this.tileSign.signText[this.editLine] = new ChatComponentText((String)s);
        if (keyCode == 1) {
