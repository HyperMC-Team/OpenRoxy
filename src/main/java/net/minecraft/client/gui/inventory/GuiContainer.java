...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ItemStack itemstack;
        Class285 stealer = Class262.getModule(Class285.class);
        if (stealer.isState() && stealer.silentValue.isEnabled()) {
            ...
            if (guiScreen instanceof GuiChest) {
                ...
                if (!stealer.silentValue.isEnabled() || chest.lowerChestInventory != null) {
                    mc.setIngameFocus();
                    mc.currentScreen = guiScreen;
                    if (stealer.silentValue.isEnabled()) {
                        Class465.drawLoadingCircle(sr.getScaledWidth() / 2, (float)sr.getScaledHeight() / 2.0f + 25.0f);
                        String tipString = "Stealing";
                        Class330.arial18.drawString(tipString, (float)this.width / 2.0f - (float) Class330.arial18.getStringWidth(tipString) / 2.0f, (float)this.height / 2.0f + 40.0f, -1, false);
                    }
                    return;
                }
            }
        ...
        if (itemstack != null) {
            ...
            if (this.draggedStack != null && this.isRightMouseClick) {
                ...
                if (itemstack.stackSize == 0) {
                    s = String.valueOf((Object)EnumChatFormatting.YELLOW) + "0";
                }
            }
        ...
        if (slotIn == this.clickedSlot && this.draggedStack != null && this.isRightMouseClick && itemstack != null) {
            ...
            if (Container.canAddItemToSlot(slotIn, itemstack1, true) && this.inventorySlots.canDragIntoSlot(slotIn)) {
                ...
                if (itemstack.stackSize > itemstack.getMaxStackSize()) {
                    s = String.valueOf((Object)EnumChatFormatting.YELLOW) + itemstack.getMaxStackSize();
                    itemstack.stackSize = itemstack.getMaxStackSize();
                }
                if (itemstack.stackSize > slotIn.getItemStackLimit(itemstack)) {
                    s = String.valueOf((Object)EnumChatFormatting.YELLOW) + slotIn.getItemStackLimit(itemstack);
