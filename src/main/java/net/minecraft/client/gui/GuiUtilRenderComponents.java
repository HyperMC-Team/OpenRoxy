...
public class GuiUtilRenderComponents {
    ...
    public static List<IChatComponent> splitText(IChatComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_) {
        ...
        ArrayList list1 = Lists.newArrayList((Iterable)p_178908_0_);
        for (int j = 0; j < list1.size(); ++j) {
            ...
            String s5 = (s4 = GuiUtilRenderComponents.func_178909_a(ichatcomponent1.getChatStyle().getFormattingCode() + s, p_178908_4_)).endsWith("\n") ? s4.substring(0, s4.length() - 1) : s4;
