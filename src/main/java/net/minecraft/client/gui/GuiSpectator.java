...
implements ISpectatorMenuRecipient {
    ...
    public void renderSelectedItem(ScaledResolution p_175263_1_) {
        ...
        if (i > 3 && this.field_175271_i != null) {
            ...
            String string = s = ispectatormenuobject != SpectatorMenu.field_178657_a ? ispectatormenuobject.getSpectatorName().getFormattedText() : this.field_175271_i.func_178650_c().func_178670_b().getFormattedText();
            if (s != null) {
