...
public class WorldRenderer {
    ...
    public class State {
        ...
        public State(WorldRenderer this$0, int[] p_i1_2_, VertexFormat p_i1_3_, TextureAtlasSprite[] p_i1_4_) {
            this.stateRawBuffer = p_i1_2_;
            this.stateVertexFormat = p_i1_3_;
            this.stateQuadSprites = p_i1_4_;
        }

        public State(WorldRenderer this$0, int[] buffer, VertexFormat format) {
