        ...
        if (meta == null) {
            ...
            if (meta.getFrameCount() > 0) {
                for (int i1 : meta.getFrameIndexSet()) {
                    ...
                    this.framesTextureData.set(i1, TextureAtlasSprite.getFrameTextureData(aint, l1, l, i1));
                }
                this.animationMetadata = meta;
            } else {
                ArrayList list = Lists.newArrayList();
                for (int j2 = 0; j2 < j1; ++j2) {
                    this.framesTextureData.add(TextureAtlasSprite.getFrameTextureData(aint, l1, l, j2));
