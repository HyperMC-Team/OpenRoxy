...
public class ClippingHelper {
    ...
    public boolean isBoxInFrustum(double p_78553_1_, double p_78553_3_, double p_78553_5_, double p_78553_7_, double p_78553_9_, double p_78553_11_) {
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            float f8 = afloat[2];
            float f9 = afloat[3];
            if (!(f6 * f + f7 * f1 + f8 * f2 + f9 <= 0.0f) || !(f6 * f3 + f7 * f1 + f8 * f2 + f9 <= 0.0f) || !(f6 * f + f7 * f4 + f8 * f2 + f9 <= 0.0f) || !(f6 * f3 + f7 * f4 + f8 * f2 + f9 <= 0.0f) || !(f6 * f + f7 * f1 + f8 * f5 + f9 <= 0.0f) || !(f6 * f3 + f7 * f1 + f8 * f5 + f9 <= 0.0f) || !(f6 * f + f7 * f4 + f8 * f5 + f9 <= 0.0f) || !(f6 * f3 + f7 * f4 + f8 * f5 + f9 <= 0.0f)) continue;
            return false;
        }
        return true;
    }
