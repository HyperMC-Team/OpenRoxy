...
import Rename.Class315;
import com.google.common.collect.Lists;
import java.nio.FloatBuffer;
import java.util.List;
import Rename.Class262;
import Rename.Class320;
...
extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        Class320 moBends = Class262.getModule(Class320.class);
        if (moBends.onRenderLivingEvent(this, (EntityLivingBase)entity, x, y, z, entityYaw, partialTicks)) {
            return;
        }
        if (Class262.getModule(Class315.class).isState() && entity instanceof EntityPlayer) {
