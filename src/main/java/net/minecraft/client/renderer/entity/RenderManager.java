...
public class RenderManager
{
    ...
    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean hideDebugBox)
    {
        ...
        catch (Throwable throwable3)
        {
            ...
            CrashReportCategory crashreportcategory1 = crashreport.makeCategory("Class129 details");
            crashreportcategory1.addCrashSection("Assigned renderer", render);
            crashreportcategory1.addCrashSection("Class235", CrashReportCategory.getCoordinateInfo(x, y, z));
            crashreportcategory1.addCrashSection("Class156", Float.valueOf(entityYaw));
