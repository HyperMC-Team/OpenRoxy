...
ITickable {
    ...
    public void processEncryptionResponse(C01PacketEncryptionResponse packetIn) {
        ...
        new Thread("Class57 Authenticator #" + AUTHENTICATOR_THREAD_ID.incrementAndGet()){
            ...
            public void run() {
                ...
                try {
                    ...
                    if (NetHandlerLoginServer.this.loginGameProfile != null) {
                        logger.info("UUID of player " + NetHandlerLoginServer.this.loginGameProfile.getName() + " is " + String.valueOf(NetHandlerLoginServer.this.loginGameProfile.getId()));
