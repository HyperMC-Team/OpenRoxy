...
public class IntegratedServer extends MinecraftServer
{
    ...
    public CrashReport addServerInfoToCrashReport(CrashReport report)
    {
        ...
        report.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>()
        {
            public String call() throws Exception
            {
                ...
                if (!s.equals("vanilla"))
                {
                    return "Definitely; Class1 brand changed to \'" + s + "\'";
                }
                else
                {
    ...
    private void fixWorldWeather(WorldServer p_fixWorldWeather_1_) {
        ...
        if (worldinfo.isRaining() || worldinfo.isThundering()) {
            ...
            this.getConfigurationManager().sendPacketToAllPlayers(new Class342(2, 0.0F));
            this.getConfigurationManager().sendPacketToAllPlayers(new Class342(7, 0.0F));
            this.getConfigurationManager().sendPacketToAllPlayers(new Class342(8, 0.0F));
        }
    }
