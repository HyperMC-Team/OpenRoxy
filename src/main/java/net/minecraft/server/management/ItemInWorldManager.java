...
public class ItemInWorldManager {
    ...
    public void setGameType(WorldSettings.GameType type) {
        ...
        this.thisPlayerMP.mcServer.getConfigurationManager().sendPacketToAllPlayers(new Class412(Class412.Action.UPDATE_GAME_MODE, this.thisPlayerMP));
    }
    ...
    public boolean tryHarvestBlock(BlockPos pos) {
        ...
        if (this.isCreative()) {
            this.thisPlayerMP.playerNetServerHandler.sendPacket(new Class382(this.theWorld, pos));
        } else {
