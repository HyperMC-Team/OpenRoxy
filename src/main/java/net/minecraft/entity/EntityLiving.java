...
extends EntityLivingBase {
    ...
    public void clearLeashed(boolean sendPacket, boolean dropLead) {
        if (this.isLeashed) {
            ...
            if (!this.worldObj.isRemote && sendPacket && this.worldObj instanceof WorldServer) {
                ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, new Class370(1, this, null));
            }
        }
    }
    ...
    public void setLeashedToEntity(Entity entityIn, boolean sendAttachNotification) {
        ...
        if (!this.worldObj.isRemote && sendAttachNotification && this.worldObj instanceof WorldServer) {
            ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, new Class370(1, this, this.leashedToEntity));
        }
    }
