...
import Rename.Class29;
import Rename.Class32;
import Rename.Class249;
...
implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        boolean isPlayer;
        boolean bl = isPlayer = this == Minecraft.getMinecraft().thePlayer;
        if (isPlayer) {
            Class29 moveEvent = new Class29(x, y, z);
            Class13.Method7(moveEvent);
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        if (player) {
            Class32 event = new Class32(forward, strafe, friction, this.rotationYaw);
    ...
    public float getClosestDistanceToEntity(Entity entityIn) {
        ...
        Vec3 pos = Entity.getNearestPointBB(eyes, entityIn.getEntityBoundingBox());
    ...
    public void writeToNBT(NBTTagCompound tagCompund) {
        try {
            ...
            tagCompund.setTag("Class156", this.newFloatNBTList(this.rotationYaw, this.rotationPitch));
    ...
    public void readFromNBT(NBTTagCompound tagCompund) {
        try {
            ...
            NBTTagList nbttaglist2 = tagCompund.getTagList("Class156", 5);
    ...
    public Class249 getCustomPositionVector() {
        return new Class249(this.posX, this.posY, this.posZ);
    }
    ...
    public Vec3 getSeverPosition() {
        return new Vec3(this.realPosX, this.realPosY, this.realPosZ);
    }
}
