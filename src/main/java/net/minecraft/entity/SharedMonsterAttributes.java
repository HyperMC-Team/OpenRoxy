...
public class SharedMonsterAttributes {
    ...
    public static final IAttribute movementSpeed = new RangedAttribute(null, "generic.movementSpeed", 0.7f, 0.0, 1024.0).setDescription("Movement Class273").setShouldWatch(true);
