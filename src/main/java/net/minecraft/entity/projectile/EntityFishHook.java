...
extends Entity {
    ...
    public void handleHookCasting(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_) {
        ...
        this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.atan2(p_146035_1_, p_146035_5_) * 180.0 / Math.PI);
        this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(p_146035_3_, f1) * 180.0 / Math.PI);
    ...
    public void onUpdate() {
        ...
        if (this.fishPosRotationIncrements > 0) {
            ...
            if (!this.inGround) {
                ...
                this.rotationPitch = (float)(MathHelper.atan2(this.motionY, f5) * 180.0 / Math.PI);
