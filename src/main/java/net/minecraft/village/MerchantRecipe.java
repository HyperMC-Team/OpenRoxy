...
public class MerchantRecipe {
    ...
    public void readFromTags(NBTTagCompound tagCompound) {
        ...
        this.maxTradeUses = tagCompound.hasKey("maxUses", 99) ? tagCompound.getInteger("maxUses") : 7;
        this.rewardsExp = tagCompound.hasKey("rewardExp", 1) ? tagCompound.getBoolean("rewardExp") : true;
    }
