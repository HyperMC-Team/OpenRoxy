...
public class BiomeDecorator {
    ...
    protected void genDecorations(BiomeGenBase biomeGenBaseIn) {
        ...
        for (int j2 = 0; j2 < k1; ++j2) {
            ...
            if (!worldgenabstracttree.generate(this.currentWorld, this.randomGenerator, blockpos)) continue;
        ...
        for (int l2 = 0; l2 < this.flowersPerChunk; ++l2) {
            ...
            if (j14 <= 0 || (blockflower = (blockflower$enumflowertype = biomeGenBaseIn.pickRandomFlower(this.randomGenerator, blockpos1 = this.field_180294_c.add(i7, k17 = this.randomGenerator.nextInt(j14), l10))).getBlockType().getBlock()).getMaterial() == Material.air) continue;
        ...
        for (int k3 = 0; k3 < this.waterlilyPerChunk; ++k3) {
            ...
            while (blockpos4.getY() > 0 && this.currentWorld.isAirBlock(blockpos7 = blockpos4.down())) {
                blockpos4 = blockpos7;
            }
        ...
        for (int l3 = 0; l3 < this.mushroomsPerChunk; ++l3) {
            ...
            if (this.randomGenerator.nextInt(8) != 0 || (j15 = this.currentWorld.getHeight(this.field_180294_c.add(j8 = this.randomGenerator.nextInt(16) + 8, 0, i12 = this.randomGenerator.nextInt(16) + 8)).getY() * 2) <= 0) continue;
