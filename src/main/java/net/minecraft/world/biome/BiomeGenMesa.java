...
extends BiomeGenBase {
    ...
    public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int x, int z, double noiseVal) {
        ...
        if (this.field_150626_aH) {
            ...
            double d0 = Math.min(Math.abs(noiseVal), this.field_150623_aE.func_151601_a((double)i * 0.25, (double)j * 0.25));
            if (d0 > 0.0) {
                d4 = d0 * d0 * 2.5;
        ...
        for (int i1 = 255; i1 >= 0; --i1) {
            ...
            if (l == -1) {
                ...
                IBlockState iblockstate4 = i1 >= 64 && i1 <= 127 ? (flag ? Blocks.hardened_clay.getDefaultState() : this.func_180629_a(x, i1, z)) : Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
