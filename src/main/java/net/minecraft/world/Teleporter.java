...
public class Teleporter {
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
        ...
        if (d0 >= 0.0) {
            if (flag) {
                this.destinationCoordinateCache.add(l, new PortalPosition(this, blockpos, this.worldServerInstance.getTotalWorldTime()));
    ...
    public boolean makePortal(Entity entityIn) {
        ...
        for (int j2 = j - i; j2 <= j + i; ++j2) {
            ...
            for (int l2 = l - i; l2 <= l + i; ++l2) {
                ...
                block2: for (int j3 = this.worldServerInstance.getActualHeight() - 1; j3 >= 0; --j3) {
                    if (!this.worldServerInstance.isAirBlock(blockpos$mutableblockpos.set(j2, j3, l2))) continue;
                        ...
                        for (int j4 = 0; j4 < 3; ++j4) {
                            for (int k4 = 0; k4 < 4; ++k4) {
                                for (int l4 = -1; l4 < 4; ++l4) {
                                    ...
                                    if (l4 < 0 && !this.worldServerInstance.getBlockState(blockpos$mutableblockpos).getBlock().getMaterial().isSolid() || l4 >= 0 && !this.worldServerInstance.isAirBlock(blockpos$mutableblockpos)) continue block2;
                                }
                            }
                        }
        ...
        if (d0 < 0.0) {
            for (int l5 = j - i; l5 <= j + i; ++l5) {
                ...
                for (int j6 = l - i; j6 <= l + i; ++j6) {
                    ...
                    block10: for (int i7 = this.worldServerInstance.getActualHeight() - 1; i7 >= 0; --i7) {
                        if (!this.worldServerInstance.isAirBlock(blockpos$mutableblockpos.set(l5, i7, j6))) continue;
                        ...
                        for (int k7 = i2; k7 < i2 + 2; ++k7) {
                            ...
                            for (int j10 = 0; j10 < 4; ++j10) {
                                for (int j11 = -1; j11 < 4; ++j11) {
                                    ...
                                    if (j11 < 0 && !this.worldServerInstance.getBlockState(blockpos$mutableblockpos).getBlock().getMaterial().isSolid() || j11 >= 0 && !this.worldServerInstance.isAirBlock(blockpos$mutableblockpos)) continue block10;
                                }
                            }
    ...
    extends BlockPos {
        ...
        public PortalPosition(Teleporter this$0, BlockPos pos, long lastUpdate) {
