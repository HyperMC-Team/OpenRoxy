    ...
    extends StructureComponent {
        ...
        protected void spawnVillagers(World worldIn, StructureBoundingBox p_74893_2_, int p_74893_3_, int p_74893_4_, int p_74893_5_, int p_74893_6_) {
            if (this.villagersSpawned < p_74893_6_) {
                ...
                int k;
                int j;
                for (int i = this.villagersSpawned; i < p_74893_6_ && p_74893_2_.isVecInside(new BlockPos(j = this.getXWithOffset(p_74893_3_ + i, p_74893_5_), k = this.getYWithOffset(p_74893_4_), l = this.getZWithOffset(p_74893_3_ + i, p_74893_5_))); ++i) {
