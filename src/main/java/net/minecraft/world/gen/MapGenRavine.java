                        ...
                        for (int j3 = k2; j3 < k; ++j3) {
                            ...
                            for (int i2 = i3; i2 < i1; ++i2) {
                                ...
                                for (int j2 = l; j2 > l2; --j2) {
                                    ...
                                    if (!((d10 * d10 + d7 * d7) * (double)this.field_75046_d[j2 - 1] + d8 * d8 / 6.0 < 1.0)) continue;
                                    IBlockState iblockstate1 = p_180707_5_.getBlockState(j3, j2, i2);
                                    if (iblockstate1.getBlock() == Blocks.grass) {
                                        flag = true;
                                    }
                                    if (iblockstate1.getBlock() != Blocks.stone && iblockstate1.getBlock() != Blocks.dirt && iblockstate1.getBlock() != Blocks.grass) continue;
                                    if (j2 - 1 < 10) {
                                    ...
                                    if (!flag || p_180707_5_.getBlockState(j3, j2 - 1, i2).getBlock() != Blocks.dirt) continue;
                                    blockpos$mutableblockpos.set(j3 + p_180707_3_ * 16, 0, i2 + p_180707_4_ * 16);
                                    p_180707_5_.setBlockState(j3, j2 - 1, i2, this.worldObj.getBiomeGenForCoords((BlockPos)blockpos$mutableblockpos).topBlock);
                                }
                            }
                        }
                        if (flag1) break;
