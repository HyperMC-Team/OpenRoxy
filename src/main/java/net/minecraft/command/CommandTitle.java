...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        Class414.Type s45packettitle$type = Class414.Type.byName(args[1]);
        if (s45packettitle$type != Class414.Type.CLEAR && s45packettitle$type != Class414.Type.RESET) {
            if (s45packettitle$type == Class414.Type.TIMES) {
                if (args.length != 5) {
                    throw new WrongUsageException("commands.title.usage", new Object[0]);
                }
                ...
                Class414 s45packettitle2 = new Class414(i, j, k);
                ...
                Class414 s45packettitle1 = new Class414(s45packettitle$type, ChatComponentProcessor.processComponent(sender, ichatcomponent, entityplayermp));
            ...
            Class414 s45packettitle = new Class414(s45packettitle$type, null);
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? CommandTitle.getListOfStringsMatchingLastWord(args, MinecraftServer.getServer().getAllUsernames()) : (args.length == 2 ? CommandTitle.getListOfStringsMatchingLastWord(args, Class414.Type.getNames()) : null);
    }
