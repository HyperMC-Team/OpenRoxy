...
public class RecipesDyes {
    public void addRecipes(CraftingManager p_77607_1_) {
        for (int i = 0; i < 16; ++i) {
            ...
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, 15 - i), "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.hardened_clay), Character.valueOf('X'), new ItemStack(Items.dye, 1, i));
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - i), "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.glass), Character.valueOf('X'), new ItemStack(Items.dye, 1, i));
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, i), "###", "###", Character.valueOf('#'), new ItemStack(Blocks.stained_glass, 1, i));
        }
        ...
        for (int j = 0; j < 16; ++j) {
            p_77607_1_.addRecipe(new ItemStack(Blocks.carpet, 3, j), "##", Character.valueOf('#'), new ItemStack(Blocks.wool, 1, j));
        }
    }
}
