...
public class ChatStyle {
    ...
    public String toString() {
        return "Style{hasParent=" + (this.parentStyle != null) + ", color=" + String.valueOf((Object)this.color) + ", bold=" + this.bold + ", italic=" + this.italic + ", underlined=" + this.underlined + ", obfuscated=" + this.obfuscated + ", clickEvent=" + String.valueOf(this.getChatClickEvent()) + ", hoverEvent=" + String.valueOf(this.getChatHoverEvent()) + ", insertion=" + this.getInsertion() + "}";
    }
        ...
        public ChatStyle deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            if (p_deserialize_1_.isJsonObject()) {
                ...
                if (jsonobject.has("color")) {
                    chatstyle.color = (EnumChatFormatting)((Object)p_deserialize_3_.deserialize(jsonobject.get("color"), EnumChatFormatting.class));
                }
