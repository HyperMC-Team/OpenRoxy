...
extends MessageToMessageDecoder<ByteBuf> {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        ...
        if (PipelineUtil.containsCause((Throwable)cause, InformativeException.class) && this.user.getProtocolInfo().getState() != State.HANDSHAKE || Via.getManager().debugHandler().enabled()) {
