...
import net.viamcp.viamcp.protocolinfo.ProtocolInfo;
...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String title = String.valueOf((Object)EnumChatFormatting.BOLD) + "ViaMCP";
        ...
        this.drawString(this.fontRendererObj, String.valueOf((Object)EnumChatFormatting.GRAY) + String.valueOf((Object)EnumChatFormatting.BOLD) + "Version Information", (this.width - this.fontRendererObj.getStringWidth("Version Information")) / 2, fixedHeight, -1);
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            GuiProtocolSelector.this.drawCenteredString(this.mc.fontRendererObj, (String)(ViaLoadingBase.getInstance().getTargetVersion().getIndex() == i ? EnumChatFormatting.GREEN.toString() + String.valueOf((Object)EnumChatFormatting.BOLD) : EnumChatFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), this.width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
